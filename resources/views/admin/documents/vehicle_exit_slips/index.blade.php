            ...
            <div class="row align-items-center justify-content-between pt-3">
                <div class="col-auto mb-3">
                    <h1 class="page-header-title text-primary">
                        ...
                        Papeletas de Salida de Vehículo
                    </h1>
                    <div class="small text-muted mt-1">Autorización y control de salidas de las unidades móviles institucionales.</div>
                </div>
                <div class="col-auto mb-3">
                    @can('vehicle_exit_slips.create')
                        <a href="{{ route('vehicle-exit-slips.create') }}" class="btn btn-primary">
    ...
    <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="row g-3 align-items-center">
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input type="text" id="filter-search" class="form-control border-start-0" placeholder="Buscar por N°, vehículo, chofer o destino...">
                    </div>
                </div>
                <div class="col-md-3">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table id="vehicle-slips-table" class="table table-hover table-striped align-middle mb-0" style="width: 100%;">
...
$(document).ready(function() {
    let table = $('#vehicle-slips-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
        ...
        columns: [
            ...
            { data: 'vehiculo_info', name: 'vehiculo' },
            { data: 'personas', name: 'solicitante_nombre' },
    ...
    $(document).on('click', '.btn-delete', function() {
        let id = $(this).data('id');
        Swal.fire({
            title: '¿Desea anular esta papeleta de vehículo?',
            icon: 'warning',
