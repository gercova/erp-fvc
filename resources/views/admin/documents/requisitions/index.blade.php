        ...
        <div class="page-header-content">
            <div class="row align-items-center justify-content-between pt-3">
                <div class="col-auto mb-3">
                    ...
                    <div class="small text-muted mt-1">Formato oficial de requerimientos institucionales para trámite y adquisiciones.</div>
                </div>
                <div class="col-auto mb-3">
    ...
    <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="row g-3 align-items-center">
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input type="text" id="filter-search" class="form-control border-start-0" placeholder="Buscar por N°, solicitante o finalidad...">
                    </div>
                </div>
                <div class="col-md-3">
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table id="requisitions-table" class="table table-hover table-striped align-middle mb-0" style="width: 100%;">
                    <thead class="table-light">
                        <tr>
                            <th class="ps-4">N° Requerimiento</th>
                            <th>Fecha</th>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.btn-delete', function() {
        let id = $(this).data('id');
        Swal.fire({
            title: '¿Está seguro de anular este requerimiento?',
