    ...
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center my-4">
            <div>
                ...
                <p class="text-muted small mb-0">Control de abastecimiento de combustible y lubricantes para vehículos y
                    maquinaria</p>
            </div>
            <div>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                <div class="row g-3 align-items-end">
                    <div class="col-md-4">
                        <label class="form-label small fw-semibold text-muted">Buscar por N°, Grifo, Vehículo o
                            Placa</label>
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0"><i
                                    class="fas fa-search text-muted"></i></span>
                            <input type="text" id="filter_search" class="form-control border-start-0"
                                placeholder="Ej: 0000041, Grifo San Juan, Hilux, EGL-123...">
                        </div>
                    </div>
                    <div class="col-md-3">
        ...
        <!-- Tabla -->
        <div class="card shadow-sm border-0 fuel-card">
        ...
        $(document).ready(function() {
            const table = $('#fuelTable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'solicitante_area',
                        name: 'user.nombres'
                    },
                    {
                        data: 'vehiculo_placa',
                        name: 'vehiculo_maquina'
                    },
                    {
                        data: 'grifo_actividad',
                        name: 'nombre_grifo'
                    },
                    {
                        data: 'total_general',
                        ...
                        $.ajax({
                            ...
                            success: function(resp) {
                                Swal.fire('Anulado', resp.message ||
                                    'El vale fue anulado.', 'success');
                                table.draw(false);
                            },
                            error: function(err) {
                                Swal.fire('Error', err.responseJSON?.message ||
                                    'No se pudo anular el vale.', 'error');
                            }
                        });
                    }
                });
